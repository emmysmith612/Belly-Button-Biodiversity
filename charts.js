function init() {
    ...
    d3.json("C:\Users\Richard\Belly-Button-Biodiversity\samples.json").then((data) => {
  ...
  function buildCharts(sample) {
    ...
    d3.json("samples.json").then((data) => {
      ...
      var samplesFilter = samplesArray.filter(data => data.id == sample);
      // Deliverable 3: 1. Create a variable that filters the metadata array for the object with the desired sample number.
      var metaFilter = data.metadata.filter(data => data.id == sample);
      // Deliverable 1: 5. Create a variable that holds the first sample in the array.
      var sampleFirst = samplesFilter[0];
      // Deliverable 3: 2. Create a variable that holds the first sample in the metadata array.
      var metaFirst = metaFilter[0];
